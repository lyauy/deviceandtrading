		...
		<tr><td>Propriété de : <?php echo $unuser->pseudo ; ?></td></tr>
			...
			if(isset($userid) && $unobjet->id_user != $userid ) {
				...
				if($unobjet->disponibilite && isset($_SESSION['userCo'])) {
					echo "<tr><td><a class='btn btn-outline-success' href=./location_form.php?id_objet='.$unobjet->id_objet.'><i class='fas fa-cart-plus'></i> Louer</a></td></tr></table>";
